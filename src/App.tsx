  ...
  return (
    <div className='container'>
      ...
      <div id='calculator'>
        ...
        <button id='clear' onClick = {() => buttonPress("clear")}className="white">C</button>
        <button id='negative' onClick = {() => buttonPress("negative")}className="white">+/-</button>
        <button id='percentage' onClick = {() => buttonPress("%")}className="white">%</button>
        <button id='divide' onClick = {() => buttonPress("/")}className="red">/</button>
        ...
        <button id='multiply' onClick = {() => buttonPress("*")}className="red">*</button>
        ...
        <button id='subtract' onClick = {() => buttonPress("-")}className="red">-</button>
        ...
        <button id='add' onClick = {() => buttonPress("+")}className="red">+</button>
